<script lang="ts">
  ...
  let endpoint = 'https://minio-e48s4k88c8oswc48os48wogo.152.70.79.39.sslip.io';
  ...
  // ... rest of your code
    ...
    try {
      await s3.send(new ListObjectsV2Command({ Bucket: tempCredentials.bucketName, MaxKeys: 1 }));
...
<div class="min-h-screen bg-base text-text p-4 md:p-8">
  <div class="max-w-6xl mx-auto">
    ...
    <header class="text-center mb-12">
      <h1 class="text-4xl font-bold text-mauve mb-2">S3 Bucket Manager</h1>
      <p class="text-lg text-subtext1 max-w-2xl mx-auto">
        A modern, user-friendly interface to manage your S3-compatible storage buckets with ease
      </p>
    </header>
      ...
      <div class="lg:col-span-2 space-y-6">
        <div class="bg-mantle rounded-xl shadow-lg overflow-hidden">
          ...
          {#if activeTab === 'connection'}
            <div class="p-6">
              <h2 class="text-2xl font-semibold mb-6">Connect to Your S3 Bucket</h2>
              <form on:submit|preventDefault={connect} class="space-y-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="space-y-1">
                    <label for="endpoint" class="block text-sm font-medium text-subtext1">Endpoint URL</label>
                    <input 
                      type="text" 
                      id="endpoint" 
                      bind:value={endpoint}
                  ...
                  <div class="space-y-1">
                    <label for="region" class="block text-sm font-medium text-subtext1">Region</label>
                    <input 
                      type="text" 
                      id="region" 
                      bind:value={region}
                ...
                <div class="space-y-1">
                  <label for="bucketName" class="block text-sm font-medium text-subtext1">Bucket Name</label>
                  <input 
                    type="text" 
                    id="bucketName" 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div class="space-y-1">
                    <label for="accessKeyId" class="block text-sm font-medium text-subtext1">Access Key ID</label>
                    <input 
                      type="text" 
                      id="accessKeyId" 
                  ...
                  <div class="space-y-1">
                    <label for="secretAccessKey" class="block text-sm font-medium text-subtext1">Secret Access Key</label>
                    <div class="relative">
                      <input 
                        type="password" 
                        id="secretAccessKey" 
                      ...
                      <button 
                        ...
                        on:click={() => {
                          const input = document.getElementById('secretAccessKey');
                ...
                {#if error}
                  <div class="mt-4 p-3 bg-red/10 border-l-4 border-red text-red-700 rounded">
          ...
          {:else if activeTab === 'guide'}
            <div class="p-6 space-y-6">
              ...
              <div class="space-y-4">
                <h3 class="text-lg font-medium text-subtext0">1. Create an S3 User</h3>
                <ul class="list-disc list-inside space-y-2 text-subtext1">
                  <li>Log in to your cloud provider's console (AWS, MinIO, etc.)</li>
              ...
              <div class="space-y-4">
                <h3 class="text-lg font-medium text-subtext0">2. Set Bucket Permissions</h3>
  ...
  "Statement": [
    {
      ...
      "Resource": [
        ...
        "arn:aws:s3:::your-bucket-name/*"
              ...
              <div class="space-y-4">
                <h3 class="text-lg font-medium text-subtext0">3. CORS Configuration</h3>
                <div class="bg-surface0 p-4 rounded-lg">
                  <pre class="text-xs overflow-x-auto">{`[{
  "AllowedHeaders": ["*"],
      ...
      <div class="space-y-6">
          ...
          <ul class="space-y-3">
            <li class="flex items-start space-x-3">
              ...
              <div>
                ...
                <p class="text-sm text-subtext1">Navigate through your buckets and folders with ease</p>
              </div>
            </li>
            <li class="flex items-start space-x-3">
              ...
              <div>
                ...
                <p class="text-sm text-subtext1">Upload files easily with drag and drop</p>
              </div>
            </li>
            <li class="flex items-start space-x-3">
              <i class="fa-solid fa-share-nodes text-yellow mt-1"></i>
              <div>
                <h4 class="font-medium">Share Files</h4>
                <p class="text-sm text-subtext1">Generate shareable links for your files</p>
              </div>
            </li>
            <li class="flex items-start space-x-3">
              ...
              <div>
                ...
                <p class="text-sm text-subtext1">Your credentials never leave your browser</p>
              </div>
            </li>
          </ul>
        </div>
        ...
        <div class="bg-mantle p-6 rounded-xl shadow-lg">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div class="flex items-center space-x-2 p-3 bg-surface0 rounded-lg">
