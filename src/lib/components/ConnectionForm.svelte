...
<div class="card p-8 max-w-lg w-full mx-auto animate-scaleIn">
  ...
  <form on:submit|preventDefault={handleSubmit} class="space-y-5">
    ...
    <div>
      <label for="customDomain" class="block text-sm font-medium text-neutral-700 dark:text-gray-300 mb-1.5">
